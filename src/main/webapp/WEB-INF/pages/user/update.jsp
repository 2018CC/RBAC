			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="loginAcc" name="loginAcc" value="${user.loginAcc }" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" id="user_name" name="user_name" value="${user.user_name }" placeholder="请输入用户名称">
				  </div>
				  <div class="form-group">
