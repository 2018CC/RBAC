			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
				  	<input type="hidden" name="id" id="roleId" value="${role[0].id }" >
					<label for="exampleInputPassword1">角色名称</label>
					<input type="text" class="form-control" id="roleName" name="roleName" value="${role[0].role_name }" placeholder="请输入角色名称">
				  </div>
	...
	<script src="script/docs.min.js"></script>
        <script type="text/javascript">
            ...
            $("#updateBtn").click(function(){
	            ...
	            if(roleName==''){
	            	layer.msg("角色名称不能为空",{time:1000,icon:5,shift:6});
	            	return;
	            }
